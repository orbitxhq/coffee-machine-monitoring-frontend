...
class RecentWaterShotDashboardView extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const RecentWaterShotDashboardView(
      {Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  _RecentWaterShotDashboardViewState createState() =>
      _RecentWaterShotDashboardViewState();
}

class _RecentWaterShotDashboardViewState
    extends State<RecentWaterShotDashboardView> {
                                ...
                                child: FutureBuilder<RecentShotStats>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return RecentShotStatsChart(
                                      points: stats.info['cumulative_water'],
