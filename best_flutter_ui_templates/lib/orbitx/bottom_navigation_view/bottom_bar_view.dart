                    ...
                    SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              child: buildTabIcon(Icons.home, 0),
                            ),
                            Expanded(
                              child: buildTabIcon(Icons.history, 1),
                            ),
                            SizedBox(
                            ...
                            Expanded(
                              child: buildTabIcon(Icons.analytics, 2),
                            ),
                            Expanded(
                              child: buildTabIcon(Icons.settings, 3),
                            ),
                          ],
                        ),
                      ),
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                              color:
                                  ORBITXTheme.nearlyDarkBlue.withOpacity(0.4),
